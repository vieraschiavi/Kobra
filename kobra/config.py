...
CLAVES = {
    ...
    "TWILIO_WHATSAPP_FROM": "Twilio · número de WhatsApp emisor (ej. whatsapp:+1…)",
    "TWILIO_WHATSAPP_CONTENT_SID": "Twilio · SID de la plantilla de WhatsApp aprobada por Meta",
...
def _keyring_disponible():
    try:
        ...
        try:
            ...
            keyring.set_password(KEYRING_SERVICE, "_kobra_probe", "ok")
            ok = keyring.get_password(KEYRING_SERVICE, "_kobra_probe") == "ok"
            keyring.delete_password(KEYRING_SERVICE, "_kobra_probe")

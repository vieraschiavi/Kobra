...
def plan_contacto_hoy(gestiones: pd.DataFrame, hoy: date | None = None,
                      ...
                      solo_contactables: bool = True) -> pd.DataFrame:
    """
    ...
    # ahora —fuera del horario legal, tope de frecuencia, No Contactar— en vez
    # de mostrar una tabla vacía sin explicación, que es lo que veía un
    # operador que abría la agenda a las nueve de la noche.
    if not solo_contactables:
